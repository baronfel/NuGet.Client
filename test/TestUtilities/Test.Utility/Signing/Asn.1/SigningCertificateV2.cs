...
{
    /*
        From RFC 5035 (https://www.rfc-editor.org/rfc/rfc5035#section-3):
    ...
    */
    public sealed class SigningCertificateV2
    {
        ...
        public SigningCertificateV2(IReadOnlyList<EssCertIdV2> certs, IReadOnlyList<PolicyInformation>? policies = null)
        {
            Certs = certs;
            Policies = policies;
        }
